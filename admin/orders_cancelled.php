...
$res = $conn->query("SELECT * FROM orders WHERE status='CANCELLED' ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<style>
		body { font-family:'Calibri','Roboto','Poppins',sans-serif; background:#979712ff; }
		...
		.btn { background:#1c2ca7ff; color:#fff; padding:8px 14px; border:none; border-radius:6px; text-decoration:none; display:inline-block; }
	</style>
</head>
<body>
	<main>
		<div class="content-card">
			...
			<div style="display:flex;gap:10px;flex-wrap:wrap;">
				...
				<a class="btn" href="print_orders.php?status=CANCELLED" target="_blank">Print Cancelled Bills</a>
			</div>
			<table>
				<thead>
					<tr>
